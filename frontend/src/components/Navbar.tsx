...
const navLinkClass = (isActive: boolean) =>
  twMerge(
    clsx(
      ...
      isActive
        ? "border-white/15 bg-white/10 text-white shadow-[0_10px_30px_rgba(4,9,20,0.28)]"
...
function Navbar({ currentUser, onLogout }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[rgba(8,17,29,0.76)] backdrop-blur-2xl">
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          {currentUser ? (
            <>
              <div className="hidden items-center gap-3 rounded-full border border-white/10 bg-white/5 px-4 py-2.5 shadow-[0_12px_30px_rgba(4,9,20,0.22)] sm:flex">
